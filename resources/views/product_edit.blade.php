    ...
    @endforeach
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="stock" id="total_stock" class="form-control bg-light fw-bold" value="{{ $product->stock }}" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row mb-4 text-center">
                        <div class="col-4">
                            ...
                            <input type="number" name="stock_ready" class="form-control form-control-sm unit-input" value="{{ $product->stock_ready }}">
                        </div>
                        <div class="col-4">
                            <label class="small fw-bold text-warning">Servis</label>
                            <input type="number" name="stock_repair" class="form-control form-control-sm unit-input" value="{{ $product->stock_repair }}">
                        </div>
                        <div class="col-4">
                            <label class="small fw-bold text-danger">Rusak</label>
                            <input type="number" name="stock_broken" class="form-control form-control-sm unit-input" value="{{ $product->stock_broken }}">
                        </div>
                    </div>

                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-warning btn-lg fw-bold text-white shadow">Update Data Barang</button>
