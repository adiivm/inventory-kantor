    ...
    public function map($product): array
    {
        ...
        foreach ($this->columns as $column) {
            if ($column == 'category_id') {
                ...
                $data[] = $product->purchase_date ? \Carbon\Carbon::parse($product->purchase_date)->format('d/m/Y') : '-';
            } elseif ($column == 'warranty_expiry_date') {
                $data[] = $product->warranty_expiry_date ? \Carbon\Carbon::parse($product->warranty_expiry_date)->format('d/m/Y') : '-';
